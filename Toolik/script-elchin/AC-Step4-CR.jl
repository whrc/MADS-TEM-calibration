...
def get_param_targets():
    return dvmdostem.get_calibration_outputs(calib=True)[16:64]
...
md = Mads.createproblem(initial_guess, obs, TEM_pycall;
    ...
    problemname="Calibration_STEP4-CR")
...
Mads.spaghettiplot(md, forward_predictions,
                       xtitle="# of observations", ytitle="GPP/NPP/VEGC/VEGN",filename="STEP4-CR_matchplot.png")

#Mads.plotmatches(md, calib_param, 
#                xtitle="# of observations", ytitle="GPP/NPP/VEGC/VEGN",filename="Step4C_matchplot.png")
