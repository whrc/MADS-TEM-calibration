...
md = Mads.createproblem(initial_guess, obs, TEM_pycall;
    ...
    problemname="Calibration_STEP3-R")
...
#    xtitle="# of observations", ytitle="NPP(Step3)",filename="STEP3_matchplot.png")
...
Mads.spaghettiplot(md, forward_predictions,
                       xtitle="# of observations", ytitle="NPP(Step3,R4)",filename="STEP3_R_matchplot.png")
